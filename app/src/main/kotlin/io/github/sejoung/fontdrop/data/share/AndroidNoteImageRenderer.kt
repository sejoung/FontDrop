...
class AndroidNoteImageRenderer(
    ...
    override suspend fun render(
        ...
        runCatching {
            ...
            canvas.translate(0f, (titleLayout.height + BLOCK_SPACING).toFloat())
    ...
    companion object {
        ...
        private val COLOR_PAPER_50 = Color.parseColor("#FFF9F0")
        private val COLOR_INK_900 = Color.parseColor("#FF173C34")
        private val COLOR_INK_500 = Color.parseColor("#FF4E786C")
    }
}
